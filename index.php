...
<body>
    <div>
        <div class="div1">
           <strong><p> Avinash's  Movie Interest</p></strong>
        </div>
        ...
        <div class="div2">
            <h1 style="padding-bottom:40px;">Add Movie Interest</h1>
            <form action="index.php" name="form" method="post">
                ...
                <div class="form-group">
                    <input   style="background-color: #f08e4c; color:#fff;"type="submit" name="sub"  class="btn btn-light">
                </div>
            </form>   
